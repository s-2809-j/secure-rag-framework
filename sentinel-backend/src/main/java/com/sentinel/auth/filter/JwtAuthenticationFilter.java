...
package com.sentinel.auth.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    // ← SecurityConfig is NOT injected here under any circumstance
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Do NOT re-throw — let the request proceed unauthenticated
            // Spring Security will return 401 at the authorization stage
        }
